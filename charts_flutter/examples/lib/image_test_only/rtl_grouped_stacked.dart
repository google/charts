...
class RTLGroupedStackedBarChart extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  RTLGroupedStackedBarChart(this.seriesList, {this.animate});

  factory RTLGroupedStackedBarChart.withSampleData() {
    return new RTLGroupedStackedBarChart(
      createSampleData(),
